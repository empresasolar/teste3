...
const STORAGE_KEY_SUPABASE_CONFIG = 'globo_solar_supabase_config';
const STORAGE_KEY_SITE_DATA = 'globo_solar_site_data';
const STORAGE_KEY_LEADS_DATA = 'globo_solar_leads_data';
...
export function generateSupabaseSqlScript(): string {
  return `-- ==============================================================================
-- SCRIPT DE CRIAÇÃO DO BANCO DE DADOS GLOBO SOLAR ENERGIA (SUPABASE / POSTGRESQL)
-- Desenvolvido para WETA SISTEMAS
-- ==============================================================================
