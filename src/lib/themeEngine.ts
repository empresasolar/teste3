...
export const PRESET_THEMES: ThemeConfig[] = [
  {
    ...
    name: 'RC Solar Oficial (Âmbar & Preto Nobre)',
    description: 'Identidade visual oficial da RC Engenharia Solar: tons de âmbar dourado, contrastes pretos e alta definição.',
    mode: 'dark',
    colors: {
      primary: '#f59e0b',
      primaryHover: '#d97706',
