...
import { Plus, Edit2, Trash2, Star, Eye, EyeOff, Save, X, AlertTriangle } from 'lucide-react';

export const TestimonialsTab: React.FC = () => {
  const { siteData, setTestimonials, deleteTestimonial, showToast } = useApp();
  ...
  // Keep local list synchronized with siteData from cloud/database updates
  useEffect(() => {
    setTestimonialsList(siteData.testimonials || []);
  ...
  const handleStartCreate = () => {
    ...
    setEditingItem({
      ...
      city: 'Rio Branco - AC',
      rating: 5,
      comment: 'Excelente atendimento da RC Engenharia Solar. Instalação rápida, suporte ágil e economia comprovada desde o primeiro mês.',
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between pb-4 border-b border-slate-200 dark:border-slate-800">
        <div>
          ...
          <p className="text-xs text-slate-500">
            Gerencie o que os clientes dizem sobre o atendimento da RC Engenharia Solar.
          </p>
        </div>
        <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-sm">
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 max-w-sm w-full p-6 space-y-4">
            ...
            <div className="text-center space-y-1">
              ...
              <p className="text-xs text-slate-500">
                Esta ação removerá este depoimento permanentemente do site e da nuvem. Deseja continuar?
              </p>
            </div>
      ...
      {editingItem && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-sm overflow-y-auto">
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 max-w-lg w-full p-6 space-y-4 my-8">
