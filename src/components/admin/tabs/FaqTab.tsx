...
export const FaqTab: React.FC = () => {
  const { siteData, setFaqs, deleteFaq, showToast } = useApp();
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-sm">
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 max-w-sm w-full p-6 space-y-4">
            ...
            <div className="text-center space-y-1">
              ...
              <p className="text-xs text-slate-500">
                Esta ação removerá esta pergunta frequente permanentemente do site. Deseja continuar?
              </p>
            </div>
