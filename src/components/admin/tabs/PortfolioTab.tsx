...
export const PortfolioTab: React.FC = () => {
  const { siteData, setPortfolio, deletePortfolioItem, showToast } = useApp();
  ...
  useEffect(() => {
    setPortfolioList(siteData.portfolio || []);
  }, [siteData.portfolio]);
      ...
      <div className="flex items-center justify-between pb-4 border-b border-slate-200 dark:border-slate-800">
        <div>
          ...
          <p className="text-xs text-slate-500">
            Cadastre fotos, potência instalada e economia das obras realizadas pela RC Engenharia Solar.
          </p>
        </div>
        <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-sm">
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 max-w-sm w-full p-6 space-y-4">
            ...
            <div className="text-center space-y-1">
              ...
              <p className="text-xs text-slate-500">
                Esta ação removerá este projeto permanentemente do portfólio. Deseja continuar?
              </p>
            </div>
            ...
            <form onSubmit={handleSaveModal} className="space-y-4">
              ...
              <div className="pt-1">
                <ImageUploader
                  ...
                  helperText="Selecione ou arraste uma foto real da obra concluída pela RC Engenharia Solar."
                />
              </div>
