    ...
    setFormData({
      ...
      features: [
        ...formData.features,
        {
          ...
          description: 'Descreva a vantagem da engenharia própria da RC Engenharia Solar.',
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          <ImageUploader
            ...
            helperText="Suba uma foto da sede, engenheiros ou instalação técnica da RC Engenharia Solar."
          />
